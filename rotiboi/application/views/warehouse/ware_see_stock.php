					...
					<table class="table table-striped" style="background-color:white;border:1px solid #EEEEEE" id="example">
						...
						$counter =0;
							foreach($rotiku->result() as $data)
							{
								...
								echo "
								<td>
									<a href='".base_url()."index.php/kendaliRoti/displayEdit/".$data->id_roti."'>
									<button type='button' class='btn btn-warning' name='edit'><span class='glyphicon glyphicon-pencil'></span> Edit</button>
									</a>
