...
<body>
<ul>
  <li><a class="text-center paddingnav putih tebal" href="<?php echo base_url();?>index.php/kendaliRoti/index">
  <span><img src="<?php echo base_url();?>tampung/assets/list2.svg" style="margin-bottom:10px;width:37%"></span>
  <br>List </a></li>
  <li><a class="active text-center paddingnav putih" href="<?php echo base_url();?>index.php/kendaliRoti/displayInput/">
  ...
  <br>PO</a></li>-->
  <li><a class="text-center paddingnav putih" href="<?php echo base_url();?>index.php/kendaliRoti/displayUser/">
  <i class="fa fa-user fa-lg putih" aria-hidden="true" style="margin-bottom:10px"></i>
  <br>User</a></li>
...
<div style="margin-left:7%;padding:1px 3px;height:500px;padding-right:0%">
	<div class="container-fluid" style="padding:0%;">
		<div class="col-lg-5" style="background-color:white;">
			<h1 style="margin-bottom:20px"> INPUT NEW ITEMS </h1>
			<div class="kotakbiru"></div>
			<form method="POST" action="<?php echo base_url();?>index.php/kendaliRoti/inputBread">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color:#2196F3">
        ...
        <h4 class="putih">Input Item Confirmation</h4>
      </div>
      <div class="modal-body">
        <p> Do you really want to input this item? </p>
      </div>
