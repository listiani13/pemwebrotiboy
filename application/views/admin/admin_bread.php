...
<body>
<ul>
  <li><a class="text-center paddingnav putih" href="admin_report.html">
  <span><img src="<?php echo base_url(); ?>/assets/assets/list.svg" style="margin-bottom:10px;width:40%"></span>
  Report </a></li>
  <li><a class="text-center paddingnav putih" href="<?php echo base_url(); ?>/index.php/Admin"><i class="fa fa-users fa-lg putih" aria-hidden="true" style="margin-bottom:10px"></i>
  Account</a></li>
  <li><a class="active text-center paddingnav putih tebal" href="admin_bread.html">
...
<div style="margin-left:5.8%;padding:1px 3px;padding-right:0%">
	<div class="container-fluid" style="padding:0%;">
		<div class="col-lg-12" style="padding-left:3.5%;height:698px;margin-left:0%;width:100%">
			<h1 style="margin-bottom:20px"> LIST BREAD </h1>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color:#EF5350">
        ...
        <h4 class="putih">Delete Bread Confirmation</h4>
      </div>
      <div class="modal-body">
        <p> Do you really want to delete this bread? </p>
      </div>
      <div class="modal-footer">
		<button type="button" class="btn btn-biruout" data-dismiss="modal">CANCEL</button>
        <a href="<?php echo base_url(); ?>/index.php/Admin"><button type="button" class="btn btn-biru">SUBMIT</button></a>
      </div>
    </div>
