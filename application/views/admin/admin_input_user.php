...
<ul>
  ...
  Bread</a></li>
  <li><a class="text-center paddingnav putih" href="<?php echo base_url(); ?>/Admin/logout"><i class="fa fa-sign-out fa-lg putih" aria-hidden="true" style="margin-bottom:10px"></i>
  Signout</a></li>
</ul>
...
<form action="addUser" method="post">
	...
	<div class="container-fluid" style="padding:0%;">
		<div class="col-lg-5" style="background-color:white;">
			<h1 style="margin-bottom:20px"> INPUT USER </h1>
